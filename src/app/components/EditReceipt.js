"use client";
// More Editing is remaining to this component !. and also modify toaster .
...
const EditReceipt = ({ receiptDetails, setEditDetails, getAllReceipts }) => {
  ...
  useEffect(() => {
    ...
    const receiptItemsArray = Array.from(receiptDetails.items, (i) => ({
      ...i,
      item: {
        value: i.item._id,
        label: i.item.name,
    ...
    setReceiptData({
      ...receiptDetails,
      receiptId: receiptDetails._id,
      items: receiptItemsArray,
    });
  }, []);
    ...
    <div className="absolute top-0 text-left left-0 max-w-screen md:w-full h-full flex flex-col items-center justify-center">
      ...
      <form className="rounded bg-white shadow-2xl w-4/5 p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-6 gap-4 mb-2">
          ...
          <div className="flex justify-center min-w-44 min-w-fit items-center bg-white text-green-500 border-2 border-slate-400 rounded font-bold">
